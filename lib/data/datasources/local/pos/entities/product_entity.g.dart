...
extension ProductEntityQuerySortBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByLastUpdate() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQuerySortThenBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByLastUpdate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdate', Sort.asc);
    });
  }
...
extension ProductEntityQueryWhereDistinct
  ...
  QueryBuilder<ProductEntity, ProductEntity, QDistinct> distinctByLastUpdate() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQueryProperty
  ...
  QueryBuilder<ProductEntity, DateTime, QQueryOperations> lastUpdateProperty() {
    return QueryBuilder.apply(this, (query) {
